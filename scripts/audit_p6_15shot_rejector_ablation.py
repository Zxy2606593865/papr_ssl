#!/usr/bin/env python
"""Audit P6 15-shot lightweight rejector ablation."""
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=Path(
            "artifacts/p6_15shot_rejector/"
            "p6_15shot_rejector_results.json"
        ),
    )
    args = p.parse_args()
    ...
    print("=" * 108)
    print("P6 15-SHOT LIGHTWEIGHT REJECTOR AUDIT")
    print("=" * 108)
    ...
    print("P6 15-SHOT REJECTOR AUDIT: PASS")
    return 0
