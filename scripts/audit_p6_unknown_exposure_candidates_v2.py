...
SCHEMA = "papr_ssl.p6_unknown_exposure_audit.v2"
...
def main() -> int:
    ...
    p.add_argument(
        "--output-dir",
        type=Path,
        default=Path("artifacts/p6_unknown_exposure_audit_v2"),
    )
    args = p.parse_args()
    ...
    print("=" * 108)
    print("P6 UNKNOWN EXPOSURE TRAIN-SIDE DATA AUDIT v2")
    print("=" * 108)
    ...
    print("P6 UNKNOWN EXPOSURE DATA AUDIT v2 STATUS: PASS")
    return 0
