#!/usr/bin/env python
"""P4-04 sequential W2v-BERT 2.0 hidden-state sweep.
...
def main() -> int:
    ...
    print("=" * 108)
    print("P4-04 W2V-BERT 2.0 LAYER SWEEP EXECUTION PLAN")
    print("=" * 108)
    ...
    (args.sweep_root / "p4_04_execution_plan.json").write_text(
        json.dumps(
            {
                "schema": "papr_ssl.p4_04_execution_plan.v1",
                "layers": list(LAYERS),
                "seeds": list(SEEDS),
                "plan": plan,
    ...
    print("-" * 108)
    print("P4-04 W2V-BERT 2.0 SWEEP EXECUTION: COMPLETE")
