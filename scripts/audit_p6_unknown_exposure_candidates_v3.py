...
SCHEMA = "papr_ssl.p6_unknown_exposure_audit.v3"
...
def main() -> int:
    ...
    p.add_argument(
        "--output-dir",
        type=Path,
        default=Path("artifacts/p6_unknown_exposure_audit_v3"),
    )
    args = p.parse_args()
    ...
    print("=" * 108)
    print("P6 UNKNOWN EXPOSURE TRAIN-SIDE DATA AUDIT v3")
    print("=" * 108)
    ...
    print("P6 UNKNOWN EXPOSURE DATA AUDIT v3 STATUS: PASS")
    return 0
